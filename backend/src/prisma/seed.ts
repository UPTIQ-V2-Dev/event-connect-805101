...
async function main() {
    ...
    const event1 = await prisma.event.upsert({
        ...
        create: {
            ...
            description:
                'Join us for our biggest company conference of the year! Network with colleagues, learn about new technologies, and celebrate our achievements.',
    ...
    const message1 = await prisma.message.upsert({
        ...
        create: {
            ...
            content:
                'Thank you for registering for our annual conference! We are excited to have you join us. Please make sure to arrive by 8:30 AM for registration and networking breakfast.',
            recipientCount: 2,
    ...
    const message2 = await prisma.message.upsert({
        ...
        create: {
            ...
            content:
                "Just a friendly reminder that the Annual Company Conference is tomorrow! Don't forget to bring your ID badge and laptop. Looking forward to seeing everyone there!",
            recipientCount: 1,
