...
const createMessageTool: MCPTool = {
    id: 'message_create',
    name: 'Create Message',
...
const scheduleMessageTool: MCPTool = {
    id: 'message_schedule',
...
const getEventMessagesTool: MCPTool = {
...
const getMessageDeliveryStatusTool: MCPTool = {
