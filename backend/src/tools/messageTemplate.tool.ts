...
const createMessageTemplateTool: MCPTool = {
    ...
    fn: async (inputs: { name: string; subject: string; content: string; category: string }) => {
...
const getMessageTemplatesTool: MCPTool = {
...
const getMessageTemplateTool: MCPTool = {
...
const updateMessageTemplateTool: MCPTool = {
...
const deleteMessageTemplateTool: MCPTool = {
...
export const messageTemplateTools: MCPTool[] = [
