...
import { Message, Prisma } from '../generated/prisma/index.js';
 ...
 */
const createMessage = async (messageData: CreateMessageInput): Promise<Message> => {
 ...
 * @returns {Promise<Message>}
 */
const scheduleMessage = async (messageData: CreateMessageInput): Promise<Message> => {
 ...
 */
const calculateRecipientCount = async (eventId: string, recipientFilter: RecipientFilter): Promise<number> => {
 ...
 * @returns {Promise<Message[]>}
 */
const getEventMessages = async (eventId: string, userId: number): Promise<Message[]> => {
 ...
 */
const getMessageById = async (messageId: string, userId: number): Promise<Message | null> => {
 ...
 */
const getMessageDeliveryStatus = async (messageId: string, userId: number): Promise<object> => {
 ...
 * @returns {object}
 */
const transformMessageToResponse = (message: Message): object => {
