...
const updateAttendeeStatusTool = {
    ...
    outputSchema: attendeeSchema,
    fn: async (inputs) => {
        const result = await attendeeService.updateAttendeeStatus(inputs.eventId, inputs.attendeeId, inputs.status, inputs.userId);
        return {
            ...result,
            registrationDate: result.registrationDate.toISOString()
        };
