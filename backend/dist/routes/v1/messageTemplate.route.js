import { messageTemplateController } from "../../controllers/index.js";
import auth from "../../middlewares/auth.js";
import validate from "../../middlewares/validate.js";
import { messageTemplateValidation } from "../../validations/index.js";
import express from 'express';
const router = express.Router();
// Authenticated routes
router
    .route('/')
    .post(auth('manageMessageTemplates'), validate(messageTemplateValidation.createMessageTemplate), messageTemplateController.createMessageTemplate)
    .get(auth('getMessageTemplates'), validate(messageTemplateValidation.getMessageTemplates), messageTemplateController.getMessageTemplates);
router
    .route('/:id')
    .get(auth('getMessageTemplates'), validate(messageTemplateValidation.getMessageTemplate), messageTemplateController.getMessageTemplate)
    .put(auth('manageMessageTemplates'), validate(messageTemplateValidation.updateMessageTemplate), messageTemplateController.updateMessageTemplate)
    .delete(auth('manageMessageTemplates'), validate(messageTemplateValidation.deleteMessageTemplate), messageTemplateController.deleteMessageTemplate);
